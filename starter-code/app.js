...
let newMesseage = (name) => `Hello, ${name}!`;

console.log(newMesseage('Allie'));
...
let Students = (name, age, hometown) => {
  this.name =name;
  this.age = age;
  this.hometown = hometown;
};

// let bob = new Students('Joe', 'Schmoe', 100);
...
// - "this" is arguments passed through the parameter of the constructor "Students".
// 2. What is "this" when joe.scopeArrow() is invoked?
// - undefinded 
// 3. Explain why "this" is different when an arrow function is used.
// - An arrow function doesn't have their own "this" value. There is no binding of "this".
